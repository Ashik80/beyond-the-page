...
const secureAuthWithOauth2Template = document.createElement("template");
secureAuthWithOauth2Template.innerHTML = `
<style>
#auth-best-practice-container p {
  margin: 1rem 0;
}
</style>
<div class="flex justify-center pt-2 pb-3">
  <div id="auth-best-practice-container" class="container">
    ...
    <p>
      ...
      in your front end code, decode and display it's information. It should not
...
return res.json({
  ...
  accessToken: oauthResponse.accessToken,
    ...
    <p>
      ...
      there that might suite your style if this one does not.
    </p>
    <p></p>
  </div>
</div>
...
export class SecureAuthWithOAuth2Page extends NavigationMixin(HTMLElement) {
  constructor() {
    super();
    this.attachShadow({ mode: "open" });
    this.shadowRoot.appendChild(
      secureAuthWithOauth2Template.content.cloneNode(true),
    );
...
customElements.define("secure-auth-with-oauth2-page", SecureAuthWithOAuth2Page);
